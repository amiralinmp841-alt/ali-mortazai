...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in ["طرح ماهانه 🛫"]:
        ...
        mahane_1 = """
<blockquote>
علی صمدی رتبه 46 کنکور و تراز 12400.کنکور پزشکی بهشتی 
...
مسعود شیدایی نژاد رتبه 400 کنکور و تراز 10500.  پزشکی تهران
</blockquote>"""
...
📚 ارائه برنامه مطالعاتی شخصی‌سازی‌شده هفتگی یا دوهفته یکبار </blockquote>
━━━━━━━━━━━━━━

<b>🥇 طرح طلایی </b>
<blockquote> 
📞 تماس تلفنی هفته‌ای ۱ بار
📝 برگزاری آزمون هفته‌ای ۱ بار
📊 پیگیری مستمر و ارائه گزارش روزانه
...
<b>💎طرح الماس</b>
<blockquote> 
📞 8 تماس در ماه (هفته ای دوبار)
📝 برگزاری آزمون هفتگی (1 بار یا بیشتر )
⏳جلسه اختصاصی‌ تحلیل آزمون و تکنیک(توسط مشاوران مختلف به صورت شخصی)
📊 آنالیز دقیق گزارش کار به صورت روزانه 
📚 ارائه برنامه به صورت هفتگی یا متغیر
🔥 2 تماس در ماه تحلیل تک درس 
(با بالاترین درصد های کنکور در اون درس )</blockquote>


<b>💎 مزایای مشترک هر 3 طرح</b>
<blockquote> 
...
🥈 طرح نقره :  1250 هزار تومان 
🥇 طرح طلایی :  1750 هزار تومان
💎طرح الماس : 3250 هزار تومان

🩺 تمامی اعضای تیم از دانشجویان پزشکی دانشگاه شهید بهشتی و تهران هستند.
✨ به‌زودی مشاوران سایر رشته‌ها نیز به مجموعه اضافه خواهند شد.
 ...
 با تلاش ، هر چیزی ممکن است👌..."""
        ...
        await update.message.reply_text("طرح ماهانه فعال هست و افراد بالا ، تا الان ظرفیت دارند که با توجه به سبک و سطح درسی شما بهترین گزینه انتخاب خواهند شد ابتدا وویس رو تا آخر گوش بدین .👌")
